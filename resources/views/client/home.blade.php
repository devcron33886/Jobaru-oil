                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                ...
                                <div class="chart-wrapper mt-3" style="height:150px;">
                                    <canvas class="chart" id="card-chart-new1" height="300"
                                        style="display: block; box-sizing: border-box; height: 150px; width: 358px;"
                                        width="716"></canvas>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="chart-wrapper" style="height:300px;margin-top:40px;">
                                <canvas class="chart" id="main-bar-chart" height="600"
                                    style="display: block; box-sizing: border-box; height: 300px; width: 310px;"
                                    width="620"></canvas>
                                <div class="chartjs-tooltip" style="opacity: 0; left: 535.169px; top: 185.42px;">
                                    <table style="margin: 0px;">
                                        <thead class="chartjs-tooltip-header">
                                            <tr class="chartjs-tooltip-header-item" style="border-width: 0px;">
                                                <th style="border-width: 0px;">Aug</th>
                                            </tr>
                                        </thead>
                                        <tbody class="chartjs-tooltip-body">
                                            <tr class="chartjs-tooltip-body-item">
                                                <td style="border-width: 0px;"><span
                                                        style="background: rgb(51, 153, 255); border-color: rgba(0, 0, 0, 0.1); border-width: 2px; margin-right: 10px; height: 10px; width: 10px; display: inline-block;"></span>Users:
                                                    85</td>
                                            </tr>
                                            <tr class="chartjs-tooltip-body-item">
                                                <td style="border-width: 0px;"><span
                                                        style="background: rgb(240, 244, 247); border-color: rgba(0, 0, 0, 0.1); border-width: 2px; margin-right: 10px; height: 10px; width: 10px; display: inline-block;"></span>New
                                                    users: 85</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <tbody>
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                ...
                                                <div class="small text-disabled"><span>New</span> | Registered: Jan 1, 2020
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between mb-1">
                                                    <div class="fw-semibold">50%</div><small class="text-disabled">Jun 11,
                                                        2020 - Jul 10, 2020</small>
                                                </div>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                ...
                                                <div class="small text-disabled"><span>Recurring</span> | Registered: Jan
                                                    1, 2020</div>
                                            </td>
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between mb-1">
                                                    <div class="fw-semibold">10%</div><small class="text-disabled">Jun 11,
                                                        2020 - Jul 10, 2020</small>
                                                </div>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between mb-1">
                                                    <div class="fw-semibold">74%</div><small class="text-disabled">Jun 11,
                                                        2020 - Jul 10, 2020</small>
                                                </div>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between mb-1">
                                                    <div class="fw-semibold">98%</div><small class="text-disabled">Jun 11,
                                                        2020 - Jul 10, 2020</small>
                                                </div>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between mb-1">
                                                    <div class="fw-semibold">22%</div><small class="text-disabled">Jun 11,
                                                        2020 - Jul 10, 2020</small>
                                                </div>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between mb-1">
                                                    <div class="fw-semibold">43%</div><small class="text-disabled">Jun 11,
                                                        2020 - Jul 10, 2020</small>
                                                </div>
                                                <div class="progress progress-thin bg-success bg-opacity-15">
                                                    <div class="progress-bar bg-success-gradient" role="progressbar"
                ...
                <div class="col-lg-3">
                    <div class="card mb-4 text-white bg-primary-gradient">
                        ...
                        <div class="chart-wrapper mt-3 mx-3" style="height:80px;">
                            <canvas class="chart" id="card-chart1" height="160"
                                style="display: block; box-sizing: border-box; height: 80px; width: 326px;"
                                width="652"></canvas>
                        </div>
                    </div>
                    <div class="card mb-4 text-white bg-warning-gradient">
                        ...
                        <div class="chart-wrapper mt-3" style="height:80px;">
                            <canvas class="chart" id="card-chart3" height="160"
                                style="display: block; box-sizing: border-box; height: 80px; width: 358px;"
                                width="716"></canvas>
                        </div>
                    </div>
                    <div class="card mb-4 text-white bg-danger-gradient">
                        ...
                        <div class="chart-wrapper mt-3 mx-3" style="height:80px;">
                            <canvas class="chart" id="card-chart4" height="160"
                                style="display: block; box-sizing: border-box; height: 80px; width: 326px;"
                                width="652"></canvas>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="border-start border-start-4 border-start-info px-3 mb-3"><small
                                                    class="text-disabled">New Clients</small>
                                        ...
                                        <div class="col-6">
                                            <div class="border-start border-start-4 border-start-danger px-3 mb-3"><small
                                                    class="text-disabled">Recuring Clients</small>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="border-start border-start-4 border-start-warning px-3 mb-3"><small
                                                    class="text-disabled">Pageviews</small>
                                        ...
                                        <div class="col-6">
                                            <div class="border-start border-start-4 border-start-success px-3 mb-3"><small
                                                    class="text-disabled">Organic</small>
